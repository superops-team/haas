...
describe("SkillsTab", () => {
  ...
  it("Add skill menu: three doors; Create with OpenHarness hands off to a conversation", async () => {
    ...
    fireEvent.click(screen.getByText("Create with OpenHarness"));
  ...
  it("the list is the page: no standing add-surfaces, no drafting remnants", async () => {
    ...
    expect(screen.queryByText("Ask OpenHarness to revise")).toBeNull();
