...
export function Icon({
  ...
  switch (name) {
    ...
    case "logo":
      // OpenHarness mark: a light bracketed H, tuned to stay readable at toolbar sizes.
      return (
        <svg {...s} strokeWidth={2.4}>
          <path d="M8.4 4.5H6.1c-1 0-1.6.6-1.6 1.6v11.8c0 1 .6 1.6 1.6 1.6h2.3" />
          <path d="M15.6 4.5h2.3c1 0 1.6.6 1.6 1.6v11.8c0 1-.6 1.6-1.6 1.6h-2.3" />
          <path d="M9.1 8.2v7.6M14.9 8.2v7.6M9.1 12h5.8" />
        </svg>
      );
    case "sidebar":
