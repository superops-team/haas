...
//
// Cloud gallery is disabled for the OpenHarness no-login product. This component
// remains only as a dormant fallback if an old navigation path opens it.
...
type Source = "all" | "openharness" | "team";

function sourceOf(p: GalleryPersona): Exclude<Source, "all"> {
  return p.publisher === "OpenHarness" ? "openharness" : "team";
}
      ...
      <div className="flex items-center gap-2 mb-4">
        {(
          [
            ...
            ["openharness", t("gallery.filter_brand")],
      ...
      <div className="absolute left-1/2 top-[6vh] -translate-x-1/2 w-[720px] max-w-[94vw] max-h-[88vh] rounded-xl2 border border-line bg-panel shadow-2xl overflow-hidden flex flex-col">
        ...
        <div className="overflow-y-auto hairline-scroll p-5">
          {loading ? (
            ...
            <div className={CARD + " p-5"} data-testid="gallery-disabled">
              <div className="min-w-0 flex-1">
                <div className="font-semibold text-[14px] mb-1">{t("gallery.disabled_title")}</div>
                <div className="text-[13px] text-muted leading-relaxed">
                  {t("gallery.disabled_desc")}
                </div>
              </div>
            </div>
          ) : detailSlug ? (
