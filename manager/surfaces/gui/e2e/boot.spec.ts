// Cold-boot fixes (owner-hit 2026-07-23): the splash wears the real OpenHarness mark
...
test("boot splash shows the OpenHarness star, not the sparkle glyph", async ({ page }) => {
  ...
  await expect(page.getByText(/Starting OpenHarness|Restoring your session/)).toBeVisible();
});
