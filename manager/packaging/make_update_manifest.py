...
uploads):
    ...
    OpenHarness-macos-arm64.app.tar.gz(.sig)   -> platforms["darwin-aarch64"]
    OpenHarness-macos-x64.app.tar.gz(.sig)     -> platforms["darwin-x86_64"]
    OpenHarness-windows-setup.exe(.sig)        -> platforms["windows-x86_64"]
...
The desktop app finds this file through https://download.openharness.dev/latest.json
...
ARTIFACTS = {
    "OpenHarness-macos-arm64.app.tar.gz": "darwin-aarch64",
    "OpenHarness-macos-x64.app.tar.gz": "darwin-x86_64",
    "OpenHarness-windows-setup.exe": "windows-x86_64",
}
