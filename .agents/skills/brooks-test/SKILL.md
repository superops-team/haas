...
2. `references/source-coverage.md` — book coverage, exceptions, tradeoffs
3. `references/test-decay-risks.md` — test-space symptom definitions and sources
4. `references/test-guide.md` — the test quality review framework

## Process

**Scope:** if the user did not share test files or point to a test directory, apply Auto
Scope Detection (`references/common.md`) first.
