...
Severity: use the T2 Severity Guide in `test-decay-risks.md`.
...
Severity: use the T3 Severity Guide in `test-decay-risks.md`, with instance
...
- If the full suite runtime is > 10 minutes → 🟡 Warning (per the T6 Severity Guide in
  `test-decay-risks.md`; runtime alone does not reach Critical)
